...
export default function sitemap() {
  ...
  return [
    ...
    { url: `${base}/blog/aloe-vera-skincare`, changeFrequency: "weekly", priority: 0.7 },
    { url: `${base}/blog/shea-butter-care`, changeFrequency: "weekly", priority: 0.7 },
    { url: `${base}/blog/natural-skincare-routine`, changeFrequency: "weekly", priority: 0.7 },
